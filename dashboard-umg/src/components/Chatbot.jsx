  ...
  const sendMessage = () => {
    ...
    setMessages((prev) => [
      ...
      { from: 'user', text },
      {
        from: 'bot',
        text: language === 'es'
          ? 'Recibí tu mensaje. Para respuestas con IA, conecta este componente a tu endpoint del chatbot.'
          : 'I received your message. For AI-powered answers, connect this component to your chatbot endpoint.',
      },
    ]);
    setInput('');
  };
